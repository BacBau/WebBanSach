<div id="header">
			...
			<div class="container">
				<div class="pull-left auto-width-left">
					<ul class="top-menu menu-beta l-inline">
						<li><a href=""><i class="fa fa-home"></i> 147 Tân Mai, Hoàng Mai, Hà Nội</a></li>
		...
		<div class="header-body">
			<div class="container beta-relative">
				<div class="pull-left">
					<a href="{{route('trang-chu')}}" id="logo"><img src="source/assets/dest/images/logo-bookk.png" width="200px" alt=""></a>
				</div>
								...
								<div class="cart-item">
									...
									<div class="media">
										...
										<div class="media-body">
											...
											<span class="cart-item-amount">{{$product['qty']}}* <span class="flash-sale">{{number_format($product['item']['unit_price'])}} đ</span></span>
