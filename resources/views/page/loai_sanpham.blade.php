...
<div class="inner-header">
		<div class="container">
			<div class="pull-left">
				<h6 class="inner-title">Danh mục: {{$loai_sp->name}}</h6>
			</div>
				...
				<div class="row">
					...
					<div class="col-sm-9">
						<div class="beta-products-list">
							<h4>Sách hay - Người bạn của tâm hồn</h4>
							<div class="beta-products-details">
								<p class="pull-left">{{count($sp_theoloai)}} sản phẩm mỗi trang</p>
								<div class="clearfix"></div>
							</div>
								...
								<div class="col-sm-4">
									<div class="single-item">
										...
										<div class="single-item-caption">
											...
											href="{{route('themgiohang',$sp_k->id)}}"><i class="fa fa-shopping-cart"></i></a>
